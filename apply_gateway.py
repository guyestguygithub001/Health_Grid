...
gateway_html = """  <!-- CLINICAL STAFF GATEWAY (Replaces Dark Login) -->
  <div id="loginScreen" style="position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: #f1f5f9; z-index: 999999; display: flex; flex-direction: column; align-items: center; justify-content: center; font-family: system-ui, sans-serif;">
...
login_pattern = r"<div id=\"loginScreen\"[^>]*>[\s\S]*?(?=<div id=\"signupModal\")"
content = re.sub(login_pattern, gateway_html + "\n\n  ", content)

header_pattern = r"<div id=\"moduleLogoText\"[^>]*>.*?</div>"
header_replace = r"\g<0>\n            <div id=\"dashboardRoleDisplay\" style=\"margin-left: 16px; padding: 4px 10px; background: #d1fae5; color: #065f46; border-radius: 9999px; font-size: 12px; font-weight: 700; letter-spacing: 0.5px; border: 1px solid #34d399;\">Role: Admin</div>"
